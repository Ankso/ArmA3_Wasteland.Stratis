			...
			if (_itemData == _x select 1) exitWith
			{
				...
				switch (_x select 3) do
				{
					...
					/*case "ammocrate":
					{
						...
						//_sbox = createVehicle [_ammoTypes call SGC_fnc_selectRandom,[(_playerPos select 0), (_playerPos select 1),0],[], 0, "NONE"];
					...
					case "weaponcrate":
					{
						...
						//_sbox = createVehicle [_weaponTypes call SGC_fnc_selectRandom,[(_playerPos select 0), (_playerPos select 1),0],[], 0, "NONE"];
						//clearMagazineCargoGlobal _sbox;
						//clearWeaponCargoGlobal _sbox;
						//clearItemCargoGlobal _sbox;
					};*/
