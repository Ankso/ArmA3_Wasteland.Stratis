...
[
	...
	// Assault Rifles
	["MK20", "arifle_Mk20_F", 300],
	["MK20 GL", "arifle_Mk20_GL_F", 500],
	["MK20 ACO", "arifle_Mk20C_ACO_F", 500],
	["TRG20 ACO + IR laser", "arifle_TRG20_ACO_pointer_F", 500],
	["TRG20 GL ACO + IR laser", "arifle_TRG21_GL_ACO_pointer_F", 700],
	["Katiba 6.5mm ACO + IR laser", "arifle_Katiba_ACO_pointer_F", 1000],
	["MX 6.5mm GL ACO", "arifle_MX_GL_ACO_F", 1500]
];

lmgArray = compileFinal str
[
	["MK200", "LMG_Mk200_F", 2500]
];
...
[
	["RPG-32", "launch_RPG32_F", 2000],
	["Titan AA", "launch_I_Titan_F", 3000]
];
...
[
	...
	["5.56x45mm 20Rnd Underwater Mag", "20Rnd_556x45_UW_mag", 10],
	["5.56x45mm 30Rnd Stanag", "30Rnd_556x45_Stanag", 50],
	["6.5x39mm 30Rnd Caseless (tracer)", "30Rnd_65x39_caseless_green", 100],
	["6.5x39mm 30Rnd Caseless", "30Rnd_65x39_caseless_mag", 100],
	["6.5x39mm 200Rnd Caseless", "200Rnd_65x39_cased_Box", 300],
	["RPG-32 AT", "RPG32_F", 500],
	["RPG-32 HE", "RPG32_HE_F", 600],
	["Igla", "Titan_AA", 1000]
];
...
[
	...
	["ACO (CQB)", "optic_aco_smg", 125, "item"],
	["Holosight (CQB)", "optic_Holosight_smg", 125, "item"],
	["ACO (Red)", "optic_Aco", 150, "item"],
	["ACO (Green)", "optic_Aco_grn", 150, "item"],
	["Holosight", "optic_Holosight", 175, "item"],
	["MRCO", "optic_MRCO", 4000, "item"],
	["ARCO", "optic_Arco", 5000, "item"],
	["RCO", "optic_Hamr", 5000, "item"]
];
...
[
	...
	["Carrier Rig (Green)", "V_PlateCarrier3_rgr", 2000, "vest"],
	...
	["ELBV Harness", "V_HarnessOSpec_brn", 500, "vest"],
	["ELBV Harness (Gray)", "V_HarnessOSpec_gry", 500, "vest"],
	...
	["Tactical Vest (Black)", "V_TacVest_blk", 1700, "vest"],
	["Tactical Vest (Brown)", "V_TacVest_brn", 1700, "vest"],
	["Tactical Vest (Camo)", "V_TacVest_camo", 1700, "vest"],
	["Tactical Vest (Khaki)", "V_TacVest_khk", 1700, "vest"],
	["Tactical Vest (Olive)", "V_TacVest_oli", 1700, "vest"],
	["Raven Night Vest", "V_TacVestIR_blk", 2500, "vest"]
];
...
[
	...
	["NV Goggles", "NVGoggles", 1500, "nvg"],
	["Diving Goggles", "G_Diving", 100, "gogg"],
	["Binoculars", "Binocular", 50, "binoc"],
	["Rangefinder", "Rangefinder", 5000, "binoc"],
	["Laser Designator", "Laserdesignator", 7500, "binoc"],
...
[
	["Empty Ammo Crate", "Box_NATO_Ammo_F", 20, "ammocrate"],
	//["Metal Barrel", "Land_MetalBarrel_F", 25, "object"],
	//["Toilet Box", "Land_ToiletBox_F", 25, "object"],
	["Lamp Post (Harbour)", "Land_LampHarbour_F", 10, "object"],
	["Lamp Post (Shabby)", "Land_LampShabby_F", 10, "object"],
	["Boom Gate", "Land_BarGate_F", 15, "object"],
	["Pipes", "Land_Pipes_Large_F", 20, "object"],
	["Concrete Frame", "Land_CncShelter_F", 20, "object"],
	["Highway Guardrail", "Land_Crash_barrier_F", 20, "object"],
	["Concrete Barrier", "Land_CncBarrier_F", 20, "object"],
	["Concrete Barrier (Medium)", "Land_CncBarrierMedium_F", 35, "object"],
	["Concrete Barrier (Long)", "Land_CncBarrierMedium4_F", 50, "object"],
	["HBarrier (1 block)", "Land_HBarrier_1_F", 15, "object"],
	["HBarrier (3 blocks)", "Land_HBarrier_3_F", 20, "object"],
	["HBarrier (5 blocks)", "Land_HBarrier_5_F", 25, "object"],
	["HBarrier Big", "Land_HBarrierBig_F", 50, "object"],
	["HBarrier Wall (4 blocks)", "Land_HBarrierWall4_F", 40, "object"],
	["HBarrier Wall (6 blocks)", "Land_HBarrierWall6_F", 50, "object"],
	["HBarrier Watchtower", "Land_HBarrierTower_F", 60, "object"],
	["Concrete Wall", "Land_CncWall1_F", 40, "object"],
	["Concrete Military Wall", "Land_Mil_ConcreteWall_F", 40, "object"],
	["Concrete Wall (Long)", "Land_CncWall4_F", 60, "object"],
	["Military Wall (Big)", "Land_Mil_WallBig_4m_F", 60, "object"],
	//["Shoot House Wall", "Land_Shoot_House_Wall_F", 18, "object"],
	["Canal Wall (Small)", "Land_Canal_WallSmall_10m_F", 40, "object"],
	["Canal Stairs", "Land_Canal_Wall_Stairs_F", 50, "object"],
	["Bag Fence (Corner)", "Land_BagFence_Corner_F", 15, "object"],
	["Bag Fence (End)", "Land_BagFence_End_F", 15, "object"],
	["Bag Fence (Long)", "Land_BagFence_Long_F", 20, "object"],
	["Bag Fence (Round)", "Land_BagFence_Round_F", 15, "object"],
	["Bag Fence (Short)", "Land_BagFence_Short_F", 15, "object"],
	["Bag Bunker (Small)", "Land_BagBunker_Small_F", 25, "object"],
	["Bag Bunker (Large)", "Land_BagBunker_Large_F", 50, "object"],
	["Bag Bunker Tower", "Land_BagBunker_Tower_F", 1000, "object"],
	["Military Cargo Post", "Land_Cargo_Patrol_V1_F", 80, "object"],
	["Military Cargo Tower", "Land_Cargo_Tower_V1_F", 2000, "object"],
	["Concrete Ramp", "Land_RampConcrete_F", 35, "object"],
	["Concrete Ramp (High)", "Land_RampConcreteHigh_F", 50, "object"],
	["Scaffolding", "Land_Scaffolding_F", 25, "object"]
];
...
[
	...
	["Assault Boat", "I_Boat_Transport_01_F", 600, "boat"],
	...
	["SDV Submarine", "I_SDV_01_F", 2000, "submarine"]
];
